...
const apiKey: string = process.env.NEXT_PUBLIC_LITEFLOW_API_KEY as string; // Cast as string if using environment variables
const url: string = `https://api.liteflow.com/${apiKey}/graphql`;
console.log(url);
...
const getEnvironment = async (): Promise<Environment> => {
  ...
  return {
    ...
    WALLET_CONNECT_PROJECT_ID:"55a59ebde25dad185d411a23f2940a0c",
